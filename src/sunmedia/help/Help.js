...
const Help = () => (
    <div className="warp clearfix">
      ...
      <div className="contant">
        ...
        <p>在有关网络广告的术语中，经常会遇到CPA、CPC、CPM、CPO、PPC、PPL、CPTM等缩写字母，这些都是有关网络广告定价方式的缩写短语，下面是关于网络广告定价模式的一组常用术语：
...
　　CPTM (Cost per Targeted Thousand Impressions) ：经过定位的用户（如根据人口统计信息定位）的千次印象费用。CPTM与CPM的区别在于，CPM是所有用户的印象数，而CPTM只是经过定位的用户的印象数。</p>
      </div>
